...
import es.garocaru.config.Constants;
import es.garocaru.JhipsterSampleApplicationApp;
import es.garocaru.domain.Authority;
import es.garocaru.domain.User;
import es.garocaru.repository.AuthorityRepository;
import es.garocaru.repository.UserRepository;
import es.garocaru.security.AuthoritiesConstants;
import es.garocaru.service.MailService;
import es.garocaru.service.dto.UserDTO;
import es.garocaru.web.rest.errors.ExceptionTranslator;
import es.garocaru.web.rest.vm.KeyAndPasswordVM;
import es.garocaru.web.rest.vm.ManagedUserVM;
import es.garocaru.service.UserService;
