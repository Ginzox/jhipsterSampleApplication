...
import es.garocaru.config.audit.AuditEventConverter;
import es.garocaru.domain.PersistentAuditEvent;
...
import static es.garocaru.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
