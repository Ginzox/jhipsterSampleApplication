...
describe('Service Tests', () => {
    ...
    describe('RegistroMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(RegistroMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/registros';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return RegistroMySuffix', () => {
